...
EquilateralTriangle<PSCustomObject>
#>

function Initialize-PSEquilateralTriangle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSEquilateralTriangle' | Write-Debug
...
Convert from JSON to EquilateralTriangle<PSCustomObject>
...
function ConvertFrom-PSJsonToEquilateralTriangle {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSEquilateralTriangle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
