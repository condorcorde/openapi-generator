...
ScaleneTriangle<PSCustomObject>
#>

function Initialize-PSScaleneTriangle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSScaleneTriangle' | Write-Debug
...
Convert from JSON to ScaleneTriangle<PSCustomObject>
...
function ConvertFrom-PSJsonToScaleneTriangle {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSScaleneTriangle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
