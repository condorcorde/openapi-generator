...
PetWithRequiredTags<PSCustomObject>
#>

function Initialize-PSPetWithRequiredTags {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSPetWithRequiredTags' | Write-Debug
...
Convert from JSON to PetWithRequiredTags<PSCustomObject>
...
function ConvertFrom-PSJsonToPetWithRequiredTags {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSPetWithRequiredTags' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
