...
ComplexQuadrilateral<PSCustomObject>
#>

function Initialize-PSComplexQuadrilateral {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSComplexQuadrilateral' | Write-Debug
...
Convert from JSON to ComplexQuadrilateral<PSCustomObject>
...
function ConvertFrom-PSJsonToComplexQuadrilateral {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSComplexQuadrilateral' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
