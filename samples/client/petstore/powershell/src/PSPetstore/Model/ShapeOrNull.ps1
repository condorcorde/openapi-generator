...
function ConvertFrom-PSJsonToShapeOrNull {
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Quadrilateral' defined in oneOf (PSShapeOrNull). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'Triangle' defined in oneOf (PSShapeOrNull). Proceeding to the next one if any."
        }
